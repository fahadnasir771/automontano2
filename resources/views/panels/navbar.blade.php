        ...
        <div class="navbar-collapse" id="navbar-mobile">
            <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                ...
                @php
                    ...
                    $name = isset(Auth::user()->name) ? Auth::user()->name : 'Demo';

                    $time = date("H");
                    
                    $timezone = date("e");
                    if ($time < "12") {
                        echo "<i style='font-size: 18px' class='feather icon-sunrise' ></i> &nbsp;" . " Good Morning, " . $name;
                    } 
                    elseif ($time >= "12" && $time < "17") {
                        echo "<i style='font-size: 18px' class='feather icon-sun' ></i> &nbsp;" . "Good Afternoon, " . $name;
                    } elseif ($time >= "17" && $time < "19") {
                        echo "<i style='font-size: 18px' class='feather icon-sunset' ></i> &nbsp;" ."Good Evening, " . $name;
                    } elseif ($time >= "19") {
                        echo "<i style='font-size: 18px' class='feather icon-moon' ></i> &nbsp;" ."Good Night, " . $name ;
                    }
                @endphp 
            ...
            <ul class="nav navbar-nav float-right">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <a class="d-flex justify-content-between" href="javascript:void(0)">
                                ...
                                <div class="media d-flex align-items-start">
                                    <div class="media-left"><i class="feather icon-check-circle font-medium-5 info"></i>
                                    </div>
                                    <div class="media-body">
                ...
                <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">
                            {{ isset(Auth::user()->name) ? Auth::user()->name : 'Demo' }}</span><span class="user-status">
                            <?php 

                                if(isset(Auth::user()->name)){
                                    $roles = [1 => 'Admin', 2 => 'Acceptor', 3 => 'Operator', 4 => 'Customer'];
                                    echo $roles[Auth::user()->role]; 
                                }else {
                                    echo 'Role';
                                }
                    ...
                    <div class="dropdown-menu dropdown-menu-right"><a onclick="alert('Under Development'); return false;" class="dropdown-item" href="page-user-profile"><i
                        ...
                        <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item"><i class="feather icon-power"></i> Logout</a>
