        ...
        <ul class="nav nav-tabs mb-3" role="tablist">
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account"
              ...
              <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Worksheet Object</span>
            </a>
          </li>
        </ul>
              ...
              <div class="row">
                  ...
                  <div class="form-group col-6">
                    <div class="controls">
                      ...
                      <input type="number" class="form-control" name="min_time" value="{{old('min_time')}}" required
                  ...
                  <div class="form-group col-6">
                    <div class="controls">
                      ...
                      <input type="number" class="form-control" name="max_time" value="{{old('max_time')}}" required
                ...
                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                  <button type="submit" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">Create Worksheet Object</button>
                </div>
              </div>
            </form>
            @else
